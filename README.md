...
1. Clone the repository and open a terminal that is pointed to the root of the repository.
2. Install dependencies by typing npm install in the terminal.
3. Start the app by typing npm start in the terminal. The app should load locally on your browser at localhost:3000.
